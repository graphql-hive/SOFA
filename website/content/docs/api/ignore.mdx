---
description: 'Simplify GraphQL object handling with Sofa. Learn how to ignore
  the default ID behavior and send entire objects using the ignore parameter.
  #GraphQL #Sofa'
title: Using objects instead of IDs
sidebarTitle: Using Objects Instead of IDs
---
...
<Callout type="info">Pattern is easy: `Type.field` or `Type`</Callout>
