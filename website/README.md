...
The documentation at [the-guild.dev/graphql/sofa-api](https://the-guild.dev/graphql/sofa-api) is
...
| Path       | What it is                                                                                                      |
| ---------- | --------------------------------------------------------------------------------------------------------------- |
| `content/` | The documentation, one folder per section (docs ). Folder order and titles come from each folder's `meta.json`. |
...
`https://sofa-api-pr-<number>.guild-dev-website.pages.dev/graphql/sofa-api` (linked in a PR comment
